...
| Conversion                  | Transformation Equation                                |   RMS | Applicable Color Range           | QA Plot                                                                                               |
|:----------------------------|:-------------------------------------------------------|------:|:---------------------------------|:------------------------------------------------------------------------------------------------------|
| $r_{LSST} \to VIS_{EUCLID}$ | $VIS_{EUCLID} - r_{LSST} = -0.072 (g-i)_{LSST}^2 -0.083 (g-i)_{LSST} +0.063$ | 0.021 | $-0.21 < (g-i)_{LSST} \leq 1.90$ | [link](_static/plots/qaPlot.LSST_DP2_to_Euclid_Q1.fit.dmag_VIS_EUCLID-r_LSST.gi_LSST.norder2.qa1.png) |
| $r_{LSST} \to VIS_{EUCLID}$ | $VIS_{EUCLID} - r_{LSST} = -0.026 (g-i)_{LSST}^2 -0.720 (g-i)_{LSST} +1.102$ | 0.05  | $1.90 < (g-i)_{LSST} \leq 3.70$  | [link](_static/plots/qaPlot.LSST_DP2_to_Euclid_Q1.fit.dmag_VIS_EUCLID-r_LSST.gi_LSST.norder2.qa1.png) |
|                             |                                                        |       |                                  |                                                                                                       |
...
| $VIS_{EUCLID} \to g_{LSST}$ | $g_{LSST} - VIS_{EUCLID} = +2.052 (VIS-Y)_{Euclid} -0.162$                           | 0.068 | $0.40 < (VIS-Y)_{Euclid} \leq 0.80$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_g_LSST-VIS_EUCLID.VISY_EUCLID.norder1.qa1.png) |
| $VIS_{EUCLID} \to g_{LSST}$ | $g_{LSST} - VIS_{EUCLID} = +1.218 (VIS-Y)_{Euclid} +0.506$                           | 0.066 | $0.80 < (VIS-Y)_{Euclid} \leq 2.18$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_g_LSST-VIS_EUCLID.VISY_EUCLID.norder1.qa1.png) |
|                             |                                                                                      |       |                                      |                                                                                                           |
| $VIS_{EUCLID} \to r_{LSST}$ | $r_{LSST} - VIS_{EUCLID} = +0.330 (VIS-Y)_{Euclid}^2 +0.153 (VIS-Y)_{Euclid} -0.050$ | 0.025 | $-0.34 < (VIS-Y)_{Euclid} \leq 0.80$ | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_r_LSST-VIS_EUCLID.VISY_EUCLID.norder2.qa1.png) |
| $VIS_{EUCLID} \to r_{LSST}$ | $r_{LSST} - VIS_{EUCLID} = +0.309 (VIS-Y)_{Euclid}^2 +0.392 (VIS-Y)_{Euclid} -0.230$ | 0.039 | $0.80 < (VIS-Y)_{Euclid} \leq 1.40$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_r_LSST-VIS_EUCLID.VISY_EUCLID.norder2.qa1.png) |
| $VIS_{EUCLID} \to r_{LSST}$ | $r_{LSST} - VIS_{EUCLID} = +0.205 (VIS-Y)_{Euclid}^2 +0.503 (VIS-Y)_{Euclid} -0.181$ | 0.044 | $1.40 < (VIS-Y)_{Euclid} \leq 2.18$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_r_LSST-VIS_EUCLID.VISY_EUCLID.norder2.qa1.png) |
|                             |                                                                                      |       |                                      |                                                                                                           |
| $VIS_{EUCLID} \to i_{LSST}$ | $i_{LSST} - VIS_{EUCLID} = -0.220 (VIS-Y)_{Euclid} -0.086$                           | 0.015 | $-0.49 < (VIS-Y)_{Euclid} \leq 1.15$ | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_i_LSST-VIS_EUCLID.VISY_EUCLID.norder1.qa1.png) |
| $VIS_{EUCLID} \to i_{LSST}$ | $i_{LSST} - VIS_{EUCLID} = -0.032 (VIS-Y)_{Euclid} -0.312$                           | 0.018 | $1.15 < (VIS-Y)_{Euclid} \leq 2.12$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_i_LSST-VIS_EUCLID.VISY_EUCLID.norder1.qa1.png) |
|                             |                                                                                      |       |                                      |                                                                                                           |
| $Y_{EUCLID} \to z_{LSST}$   | $z_{LSST} - Y_{EUCLID} = +0.466 (VIS-Y)_{Euclid} -0.052$                             | 0.018 | $-0.49 < (VIS-Y)_{Euclid} \leq 0.60$ | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_z_LSST-Y_EUCLID.VISY_EUCLID.norder1.qa1.png)   |
| $Y_{EUCLID} \to z_{LSST}$   | $z_{LSST} - Y_{EUCLID} = +0.294 (VIS-Y)_{Euclid} +0.049$                             | 0.018 | $0.60 < (VIS-Y)_{Euclid} \leq 1.25$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_z_LSST-Y_EUCLID.VISY_EUCLID.norder1.qa1.png)   |
| $Y_{EUCLID} \to z_{LSST}$   | $z_{LSST} - Y_{EUCLID} = +0.455 (VIS-Y)_{Euclid} -0.158$                             | 0.016 | $1.25 < (VIS-Y)_{Euclid} \leq 2.19$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_z_LSST-Y_EUCLID.VISY_EUCLID.norder1.qa1.png)   |
|                             |                                                                                      |       |                                      |                                                                                                           |
| $Y_{EUCLID} \to y_{LSST}$   | $y_{LSST} - Y_{EUCLID} = +0.226 (VIS-Y)_{Euclid} -0.010$                             | 0.027 | $-0.49 < (VIS-Y)_{Euclid} \leq 0.60$ | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_y_LSST-Y_EUCLID.VISY_EUCLID.norder1.qa1.png)   |
| $Y_{EUCLID} \to y_{LSST}$   | $y_{LSST} - Y_{EUCLID} = +0.122 (VIS-Y)_{Euclid} +0.047$                             | 0.024 | $0.60 < (VIS-Y)_{Euclid} \leq 2.19$  | [link](_static/plots/qaPlot.Euclid_Q1_to_LSST_DP2.fit.dmag_y_LSST-Y_EUCLID.VISY_EUCLID.norder1.qa1.png)   |
